...
export default function UpdateLodge({ id }) {

    const { updateLodgeById, name, setName, size, setSize, bedroom, setBedroom, bathroom, setBathroom, capacity, setCapacity, high, setHigh, medium, setMedium, low, setLow } = useLodge();

    const handleSubmit = async(e) => {
        e.preventDefault();
        await updateLodgeById(id)
    };
